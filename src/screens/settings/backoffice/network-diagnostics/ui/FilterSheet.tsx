...
const styles = StyleSheet.create({
  ...
  segmentTextActive: { color: colors.brandText },
  toggleRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  toggleLabel: { color: colors.text, fontSize: 13.5, fontWeight: '500' },
  track: {
    width: 44,
    height: 25,
    borderRadius: 999,
  ...
  applyText: { color: colors.onBrand, fontSize: 14, fontWeight: '700' },
});
